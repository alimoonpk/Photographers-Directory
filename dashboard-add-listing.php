    ...
    if(empty($studioname)){
        ...
        global $ConnectingDB;
        $Query="INSERT INTO photographerdata(datetime,studioname,personname,category,overview,pricingpp,pricingph,cell,web,email,pic1,pic2,pic3,pic4)
        VALUES('$DateTime','$studioname','$personname','$Category','$overview','$pricingpp','$pricingph','$cell','$web','$email','$Image1','$Image2','$Image3','$Image4')";
        ...
        if($Execute){
        $_SESSION["SuccessMessage"]="Listing Added Successfully";
        Redirect_to("dashboard-add-listing.php");
        }else{
    ...
    <div id="dashboard">
        ...
        <div class="dashboard-content">
	      ...
	      echo SuccessMessage();
	?>
<form action="dashboard-add-listing.php" method="post" enctype="multipart/form-data">
                            <!-- Headline -->
                            ...
                            <div class="row with-forms">
                                <div class="col-md-12">
                                    ...
                                    <input name="Studioname" class="search-field" type="text" value=""/>
                                    <h5>Owner Name</h5>
                                    <input name="Personname" class="search-field" type="text" value=""/>
                                </div>
                            </div>
    ...
    ?>	
        ...
        <?php } ?>
                        ...
                        <div class="add-listing-section margin-top-45">
                            ...
                            <div class="form">
                                <h5>Description</h5>
                                <textarea name="Overview" class="WYSIWYG" name="summary" cols="40" rows="3" id="summary" spellcheck="true"></textarea>
                            </div>
                            ...
                            <div class="row with-forms">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input name="Pricingpp" type="text">
                                </div>

                                <!-- Website -->
                                <div class="col-md-6">
                                    <h5 class="twitter-input">Pricing Per Hour<span>(Video)</span></h5>
                                    <input name="Pricingph" type="text">
                                </div>
                        ...
                        <input class="button preview" type="Submit" name="Submit" value="Add New Listing">
